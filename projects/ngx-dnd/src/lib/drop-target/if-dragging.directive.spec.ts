...
@Component({
  template: `<div vcDropTarget [itemType]="'test'"><ng-template vcIfDragging [hideWhenOver]="true"><div class="test"></div></ng-template></div>
    <div vcDropTarget [itemType]="'test2'"><div class="test2" *vcIfDragging></div></div>
    <div class="test3" *vcIfDragging></div>`
})
class TestComponent {}
