...
@Component({
  template: `<div vcDropTarget [itemType]="itemTypes" (dragging)="onDrag($event)" (hovered)="onHover($event)" (dropped)="onDrop($event)"></div>`
})
class TestComponent {
...
describe('DropTarget', () => {
  ...
  it('should avcept a string as itemType', () => {
