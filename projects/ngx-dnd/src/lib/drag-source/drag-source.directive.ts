import { Directive, AfterViewInit, OnDestroy, Input, TemplateRef, Output, EventEmitter, NgZone, ElementRef, Optional } from '@angular/core';
...
@Directive({
  selector: '[vcDragSource]',
  exportAs: 'vcDragSource'
})
export class DragSourceDirective<T = any> implements AfterViewInit, OnDestroy {
